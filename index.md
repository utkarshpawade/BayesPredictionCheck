...
**predictCheckR** provides a clean, minimal toolkit for Bayesian
posterior predictive checking (PPC) built on the
...
replicated data from the fitted model and comparing those simulations to
the observed data. Systematic discrepancies reveal aspects of the
data-generating process that the model fails to capture — before any
information criterion is consulted.
...
log-likelihood but do not tell you *how* a model fails. Predictive
checking places simulated and observed data side by side, making model
deficiencies immediately visible:
...
| Function                                                                                                      | Purpose                                                                                                                            |
|---------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------|
| [`simulate_ppc()`](https://utkarshpawade.github.io/predictCheckR/reference/simulate_ppc.md)                   | Generate $S \times n$ posterior predictive sample matrix                                                                           |
| [`ppc_diagnostics()`](https://utkarshpawade.github.io/predictCheckR/reference/ppc_diagnostics.md)             | Compute mean diff, variance diff, Bayesian $p$-value, RMSE, coverage                                                               |
| [`print.ppc_diagnostics()`](https://utkarshpawade.github.io/predictCheckR/reference/print.ppc_diagnostics.md) | Formatted S3 print method                                                                                                          |
| [`plot_ppc_overlay()`](https://utkarshpawade.github.io/predictCheckR/reference/plot_ppc_overlay.md)           | Density overlay plot (wraps [`bayesplot::ppc_dens_overlay`](https://mc-stan.org/bayesplot/reference/PPC-distributions.html))       |
| [`plot_ppc_stat()`](https://utkarshpawade.github.io/predictCheckR/reference/plot_ppc_stat.md)                 | Test-statistic distribution plot (wraps [`bayesplot::ppc_stat`](https://mc-stan.org/bayesplot/reference/PPC-test-statistics.html)) |
| [`compare_models_ppc()`](https://utkarshpawade.github.io/predictCheckR/reference/compare_models_ppc.md)       | Side-by-side predictive performance table (RMSE, MAE, variance gap)                                                                |
| [`theme_ppc()`](https://utkarshpawade.github.io/predictCheckR/reference/theme_ppc.md)                         | Clean ggplot2 theme for publication-quality PPC figures                                                                            |
...
MIT © 2026 predictCheckR Maintainer. See
[LICENSE.md](https://utkarshpawade.github.io/predictCheckR/LICENSE.md).
